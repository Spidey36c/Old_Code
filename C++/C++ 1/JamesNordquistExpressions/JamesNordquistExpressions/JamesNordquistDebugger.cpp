...
* 5) Step Into until you reach the first printf statement. With
*    the current line being that printf statement, Step Into again.
...
* 9) In Visual Studio you will be taken back to the same printf
...
* 2) Step over the printf.
* 3) Step over the scanf. Notice that you can now enter a value.
...
int main()
{
	...
	printf("You have $%6.2f\n", money);

	// Breakpoint 1
	// Put a breakpoint on the following line
	printf("Enter percent raise: ");
	scanf("%f", &raise);

	money = money +(money * raise);

	printf("After your raise you have $%6.2f\n", money);
