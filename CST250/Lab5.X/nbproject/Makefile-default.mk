...
SOURCEFILES_QUOTED_IF_SPACED=Lab5new.S

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/Lab5new.o
POSSIBLE_DEPFILES=${OBJECTDIR}/Lab5new.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/Lab5new.o

# Source Files
SOURCEFILES=Lab5new.S
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/Lab5new.o: Lab5new.S  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/Lab5new.o.d 
	@${RM} ${OBJECTDIR}/Lab5new.o 
	@${RM} ${OBJECTDIR}/Lab5new.o.ok ${OBJECTDIR}/Lab5new.o.err 
	@${FIXDEPS} "${OBJECTDIR}/Lab5new.o.d" "${OBJECTDIR}/Lab5new.o.asm.d" -t $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC} $(MP_EXTRA_AS_PRE)  -D__DEBUG -D__MPLAB_DEBUGGER_SIMULATOR=1 -c -mprocessor=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/Lab5new.o.d"  -o ${OBJECTDIR}/Lab5new.o Lab5new.S  -DXPRJ_default=$(CND_CONF)  -legacy-libc  -Wa,--defsym=__MPLAB_BUILD=1$(MP_EXTRA_AS_POST),-MD="${OBJECTDIR}/Lab5new.o.asm.d",--defsym=__MPLAB_DEBUG=1,--gdwarf-2,--defsym=__DEBUG=1,--defsym=__MPLAB_DEBUGGER_SIMULATOR=1
...
${OBJECTDIR}/Lab5new.o: Lab5new.S  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/Lab5new.o 
	@${RM} ${OBJECTDIR}/Lab5new.o.ok ${OBJECTDIR}/Lab5new.o.err 
	@${FIXDEPS} "${OBJECTDIR}/Lab5new.o.d" "${OBJECTDIR}/Lab5new.o.asm.d" -t $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC} $(MP_EXTRA_AS_PRE)  -c -mprocessor=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/Lab5new.o.d"  -o ${OBJECTDIR}/Lab5new.o Lab5new.S  -DXPRJ_default=$(CND_CONF)  -legacy-libc  -Wa,--defsym=__MPLAB_BUILD=1$(MP_EXTRA_AS_POST),-MD="${OBJECTDIR}/Lab5new.o.asm.d",--gdwarf-2
