...
ProjectDir="D:\CST250\Lab6.X"
ConfName=default
ImagePath="dist\default\${IMAGE_TYPE}\Lab6.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}"
ImageDir="dist\default\${IMAGE_TYPE}"
ImageName="Lab6.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}"
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
IsDebug="true"
else
IsDebug="false"
...
${OBJECTDIR}/Lab6.o: Lab6.S  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/Lab6.o 
	@${RM} ${OBJECTDIR}/Lab6.o.ok ${OBJECTDIR}/Lab6.o.err 
	@${FIXDEPS} "${OBJECTDIR}/Lab6.o.d" "${OBJECTDIR}/Lab6.o.asm.d" -t $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC} $(MP_EXTRA_AS_PRE)  -D__DEBUG -D__MPLAB_DEBUGGER_SIMULATOR=1 -c -mprocessor=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/Lab6.o.d"  -o ${OBJECTDIR}/Lab6.o Lab6.S  -DXPRJ_default=$(CND_CONF)  -legacy-libc  -Wa,--defsym=__MPLAB_BUILD=1$(MP_EXTRA_AS_POST),-MD="${OBJECTDIR}/Lab6.o.asm.d",--defsym=__MPLAB_DEBUG=1,--gdwarf-2,--defsym=__DEBUG=1,--defsym=__MPLAB_DEBUGGER_SIMULATOR=1
...
${OBJECTDIR}/Lab6.o: Lab6.S  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/Lab6.o 
	@${RM} ${OBJECTDIR}/Lab6.o.ok ${OBJECTDIR}/Lab6.o.err 
	@${FIXDEPS} "${OBJECTDIR}/Lab6.o.d" "${OBJECTDIR}/Lab6.o.asm.d" -t $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC} $(MP_EXTRA_AS_PRE)  -c -mprocessor=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/Lab6.o.d"  -o ${OBJECTDIR}/Lab6.o Lab6.S  -DXPRJ_default=$(CND_CONF)  -legacy-libc  -Wa,--defsym=__MPLAB_BUILD=1$(MP_EXTRA_AS_POST),-MD="${OBJECTDIR}/Lab6.o.asm.d",--gdwarf-2
